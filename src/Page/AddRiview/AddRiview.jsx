                ...
                <div className="p-2 w-1/2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      name="name"
                      placeholder="Name"
                      className="input border-white focus:border-white dark:border-2 h-one input-bordered w-full max-w-xs"
                    />
                  </div>
                </div>
                <div className="p-2 w-1/2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      name="ratting"
                      placeholder="rating"
                      className="input h-one focus:border-white  dark:border-2 input-bordered border-white w-full max-w-xs"
                    />
                  </div>
                </div>
                <div className="p-2 w-full ">
                  <div className="relative">
                    ...
                    <input
                      ...
                      name="image"
                      placeholder="photo"
                      className="input h-one  focus:border-white dark:border-2  input-bordered border-white w-full "
                    />
                  </div>
                </div>
